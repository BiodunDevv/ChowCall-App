...
export function Iphone({ src, videoSrc, children, className, style, ...props }: IphoneProps) {
  ...
  const hasSrc = !hasVideo && !!src;
  const hasChildren = !!children;
  const hasMedia = hasVideo || hasSrc || hasChildren;
  ...
  return (
    <div
      ...
      {...props}
    >
      {/* Screen content layer — sits beneath the SVG frame */}
      {hasChildren && (
        <div
      ...
      {/* SVG frame — sits on top of screen content */}
      <svg
