		...
		<section className="mx-auto w-full max-w-5xl">
			...
			<div className="relative flex flex-col items-center justify-center gap-5 pt-32 pb-30">
				...
				>
					...
					<span className="text-xs">AI phone ordering for restaurants</span>
				...
				>
					Every call. Every order. <br /> Handled.
				</h1>
				...
				<p className="fade-in slide-in-from-bottom-10 mx-auto px-4 max-w-2xl animate-in fill-mode-backwards text-center text-sm text-foreground/80 tracking-wider delay-200 duration-500 ease-out sm:text-lg md:text-xl">
					ChowCall is the AI phone assistand that answers restaurant calls, takes orders, calculates delivery and service fees, collects payment, and sends paid tickets to the kitchen. 
				</p>
